...
@Component({
    selector: 'dashboard-profile-view',
    templateUrl: './dashboard-profile.view.html',
    styleUrls: ['./dashboard-profile.view.css']

})
///default view is a catch all - we catch this view on the initial home route.  
export class DashboardProfileView implements OnInit{
  Data: Observable<any>;
  subData;
